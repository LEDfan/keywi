...
function init() {
    ...
    browser.runtime.getPlatformInfo().then(function(platformInfo) {
        if (platformInfo.os === "win") {
            Keepass.prompts.setWindowSize(400, 640);
            LocalSecureStorage.prompts.setWindowSize(400, 640);
        } else {
            Keepass.prompts.setWindowSize(380, 600);
            LocalSecureStorage.prompts.setWindowSize(380, 600);
        }
